...
public class CreateOrgWithEmailTest {

	@Test
	public void createOrgWithEmailTest() throws Throwable {
		/*create Objects */
		...
		/*read test data*/
		String orgName = elib.getExcelData("org", 7, 2) + "_"+jLib.getRandomData();
		String industries = elib.getExcelData("org", 7, 3);
		String employeCount = elib.getExcelData("org", 7, 4);
		String email = elib.getExcelData("org", 7, 5);
		...
		cnop.createOrg(orgName, industries, employeCount ,email);
